...
@section('content')
    ...
    <section class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mt-8 sm:mt-10 lg:mt-14">
            <header class="mb-8 sm:mb-10 lg:mb-14">
                <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-8 sm:mb-10 lg:mb-14">
                    Review Your <span class="text-primary">Booking</span>
                </h1>
                <div class="w-full mx-auto bg-white px-4 sm:px-6 lg:px-10">
            ...
            <form id="booking-form" action="{{ route('booking_store', $destination->slug) }}" method="POST">
                @csrf
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 text-gray-1 font-medium">
                    <div class="lg:col-span-2 space-y-4 sm:space-y-5 lg:space-y-7">
                        <div class="w-full border border-gray-4 rounded-[10px] p-4 sm:p-5 lg:p-7">
                            <h3 class="text-lg sm:text-xl mb-4 sm:mb-5 lg:mb-7 border-b border-gray-4 pb-2">Tour Details
                            </h3>
                            <h3 class="text-lg sm:text-xl font-semibold mb-4 sm:mb-5 lg:mb-7">{{ $destination->title }}</h3>
                            <div class="flex flex-col gap-y-3 sm:gap-y-4 lg:gap-y-5 text-xs sm:text-sm max-w-sm">
                        ...
                        <div class="traveller-details w-full border border-gray-4 rounded-[10px] p-4 sm:p-5 lg:p-7">
                            <h3 class="text-lg sm:text-xl mb-4 sm:mb-5 lg:mb-7">Traveller Details</h3>
                            @include('front.partials.traveller-details')
                        </div>
                        <div
                            class="contact w-full border border-gray-4 rounded-[10px] p-4 sm:p-5 lg:p-7 space-y-4 sm:space-y-5 lg:space-y-7">
                            <div
                                class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-7">
                                <h3 class="text-lg sm:text-xl">Contact Details</h3>
                                <p class="text-xs text-gray-4 font-medium">
                                    <span class="text-red-500">*</span>Your booking information will be sent here
                                </p>
                            </div>
                            <div
                                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 text-xs sm:text-sm font-medium text-gray-3">
                        ...
                        <div class="notes w-full">
                            <div class="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-5">
                                ...
                                <h3 class="text-lg sm:text-xl">Notes</h3>
                            </div>
                            <textarea name="notes" id="notes" cols="30" rows="10"
                                class="w-full border border-gray-4 rounded-[10px] p-4 sm:p-5 lg:p-7 text-xs sm:text-sm text-gray-4 font-medium focus:outline-none resize-none"
