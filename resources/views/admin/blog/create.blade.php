                ...
                <form action="{{ route('admin_blog_store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content"
                            class="summernote w-full border border-gray-300 rounded-lg px-4 py-2 h-64 focus:ring focus:ring-blue-200" required></textarea>
                    </div>
                    ...
                    <button type="submit"
                        class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Create
                        Post</button>
                </form>
            </div>
        </div>
